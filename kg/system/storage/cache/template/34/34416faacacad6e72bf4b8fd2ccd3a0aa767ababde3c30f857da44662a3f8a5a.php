...
class __TwigTemplate_c3ee3341f742ed6bc07f89d977ce74d171bcbb015878a6cd8fd9ff6048707a9f extends Template
{
    private $source;
    private $macros = [];
    ...
    <?php foreach (\$categories as \$category) { ?>
        <div class=\"category-item\" style=\"position: relative\">
            <div class=\"category-item__inner\">
                <a class=\"category-link <?php echo \$category['class']; ?>\" href=\"<?php echo \$category['href']; ?>\"><?php echo \$category['name']; ?></a>
                            ...
                            <div class=\"category-popup-sub-menu__item\">
                                <?php foreach (\$category['children'] as \$child) { ?>
                                    <div class=\"category-popup-sub-menu__link-wrapper\">
                                        <a class=\"subcategory-link <?php echo \$child['class']; ?>\" href=\"<?php echo \$child['href']; ?>\"><?php echo \$child['name']; ?></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
