...
class __TwigTemplate_3c776123d97933de64679064a815714feee863fea035d1cbabf0df0e677b91af extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        // line 402
        echo "
<div class=\"wrapper\" id=\"accordion-menu\"><nav class=\"mobile navbar m-navbar navbar-light\"><div class=\"m-navbar__item\">
...
\t\t\t\t\t\t</button></div><div class=\"m-navbar__item m-navbar__logo\">
...
\t\t\t\t\t\t</a></div><div class=\"m-navbar__item m-navbar__menu\"><ul class=\"mobile m-nav\"><li class=\"m-nav__item\">
...
\t\t\t\t\t\t\t\t</a></li></ul></div></nav><div class=\"mobile collapse m-collapse\" id=\"navbarToggleMenu\" data-parent=\"#accordion-menu\"><div class=\"m-collapse__menu\"><div class=\"site-info m-site-info\"><div class=\"mobile site-info-block\"><div class=\"site-info-images\"><div class=\"site-info-brand\">
\t\t\t\t\t\t\t\t\t\t<img alt=\"\" src=\"/thumbs/resize/160x100/uploads/settings/94522862364ae9206d391e.png\"></div><hr><div class=\"site-info-cert\">
\t\t\t\t\t\t\t\t\t\t<img alt=\"\" src=\"/thumbs/resize/78x110/uploads/settings/16673753264b446664d827.jpg\"></div></div><p class=\"site-info-description\">
\t\t\t\t\t\t\t\t\tСпециализированный сайт по продукции
\t\t\t\t\t\t\t\t\t<strong>Hikvision</strong></p></div></div>
...
\t\t\t\t\t\t</button><ul class=\"mobile m-nav m-nav_vertical\"><li class=\"m-nav__item m-nav__item_vertical\">
...
\t\t\t\t\t\t\t\t</a></li><li class=\"m-nav__item m-nav__item_vertical\">
...
\t\t\t\t\t\t\t\t</a></li></ul></div><div class=\"m-collapse__backdrop\" data-toggle=\"collapse\" aria-expanded=\"false\" data-target=\"#navbarToggleMenu\" aria-controls=\"navbarToggleMenu\"></div></div><div class=\"mobile collapse m-collapse\" id=\"navbarToggleContacts\" data-parent=\"#accordion-menu\"><div class=\"collapse-control-wrapper\"><div class=\"collapse-control\">
...
\t\t\t\t\t\t\t</button></div></div><div class=\"m-collapse__contacts\"><div class=\"site-info m-site-info m-0\"><div class=\"mobile site-info-block\"><div class=\"site-info-images\"><div class=\"site-info-brand\">
\t\t\t\t\t\t\t\t\t\t<img alt=\"\" src=\"/thumbs/resize/160x100/uploads/settings/94522862364ae9206d391e.png\"></div><hr><div class=\"site-info-cert\">
\t\t\t\t\t\t\t\t\t\t<img alt=\"\" src=\"/thumbs/resize/78x110/uploads/settings/16673753264b446664d827.jpg\"></div></div><p class=\"site-info-description\">
\t\t\t\t\t\t\t\t\tСпециализированный сайт по продукции
\t\t\t\t\t\t\t\t\t<strong>Hikvision</strong></p></div><ul class=\"mobile contacts-block\"><li class=\"nav-item\">
\t\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"tel:+74954324141\">
\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-phone\"></i> +7 (495) 432-41-41 </a></li><li class=\"nav-item nav-item-callback-link\">
\t\t\t\t\t\t\t\t\t<a class=\"callback-link\" data-toggle=\"modal\" data-target=\"#callback-dialog\">Заказать обратный звонок</a></li><li class=\"nav-item\">
\t\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"mailto:info@Hikvision-Shop.ru\">
\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-envelope\"></i> info@Hikvision-Shop.ru </a></li><li class=\"nav-item\">
\t\t\t\t\t\t\t\t\t<a class=\"nav-link whatsapp-link\" href=\"https://wa.me/+79361323454\" target=\"_blank\">
\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-whatsapp\"></i> WhatsApp: 8 (936) 132-34-54
...
\t\t\t\t\t\t\t\t\t\tTelegram: ShopMSK1 </a></li></ul></div></div><div class=\"m-collapse__backdrop\" data-toggle=\"collapse\" aria-expanded=\"false\" data-target=\"#navbarToggleContacts\" aria-controls=\"navbarToggleContacts\"></div></div><div class=\"mobile collapse m-collapse\" id=\"navbarToggleCatalog\" data-parent=\"#accordion-menu\"><div class=\"collapse-control-wrapper pb-0\"><div class=\"collapse-control\">
...
\t\t\t\t\t\t\t\t<img src=\"\" alt=\"\" class=\"lazyload collapse-control__button-close-image\" data-src=\"/thumbs/color/080806/img/cross.png\">
\t\t\t\t\t\t\t</button></div></div><div class=\"search-line\"><form class=\"search_form\" role=\"search\" method=\"get\" action=\"/search\"><div class=\"input-group\">
...
\t\t\t\t\t\t\t\t\t</button></div><div class=\"search-line__dropdown-content\"></div></div></form></div><div class=\"m-collapse__catalog\"><ul class=\"mobile m-category-menu\"><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kamerivideonablyudeniya/27\">Камеры</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/videodomofoni/43\">Видеодомофоны</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/videoregistratori/7\">Видеорегистраторы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/vizivnie_paneli/44\">Вызывные панели</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/datchiki/34\">Датчики</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/domofoni/19\">Домофоны</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/zamki/26\">Замки</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/bloki_pitaniya/45\">Блоки питания</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/izveshchateli/37\">Извещатели</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kabel/24\">Кабель</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/klaviaturi_upravleniya/51\">Клавиатуры
\t\t\t\t\t\t\t\t\tуправления</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/koguh/52\">Кожух</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kommutatori/17\">Коммутаторы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kontrolleri/47\">Контроллеры</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kontrolnie_paneli/30\">Контрольные панели</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/kronshteyni/12\">Кронштейны</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/monitori/18\">Мониторы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/obektivi/20\">Объективы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/opticheskie_moduli/28\">Оптические модули</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/pulti_upravleniya/10\">Пульты управления</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/rasshiriteli_shini/31\">Расширители шины</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/servera/16\">Сервера</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/sireni/33\">Сирены</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/schitivateli/25\">Считыватели </a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/terminali/49\">Терминалы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/trevognie_knopki/39\">Тревожные кнопки</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/udliniteli_poe/29\">Удлинители poe</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/teplovizor/53\">Тепловизор</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/ups-produkty/235\">UPS
\t\t\t\t\t\t\t\t\tпродукты</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/ip-spikerfon/236\">IP
\t\t\t\t\t\t\t\t\tспикерфон</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/komplektuusie/237\">Комплектующие</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/po/238\">ПО</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/turnikety/239\">Турникеты</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/metallodetektory/240\">Металлодетекторы</a></li><li class=\"m-category-menu__item\">
\t\t\t\t\t\t\t\t<a class=\"m-category-menu__link\" href=\"/category/slagbaumy/241\">Шлагбаумы</a></li></ul></div><div class=\"m-collapse__backdrop\" data-toggle=\"collapse\" aria-expanded=\"false\" data-target=\"#navbarToggleCatalog\" aria-controls=\"navbarToggleCatalog\"></div></div><nav class=\"desktop page-menu\"><ul class=\"nav\"><li class=\"nav-item\">
...
\t\t\t\t\t\t\t\tГарантия </a></li><li class=\"nav-item\">
...
\t\t\t\t\t\t\t\tОплата </a></li><li class=\"nav-item\">
\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"/delivery\">
\t\t\t\t\t\t\t\t<i class=\"fa fa-truck\"></i>
\t\t\t\t\t\t\t\tДоставка </a></li><li class=\"nav-item\">
...
\t\t\t\t\t\t\t\tКонтакты </a></li><li class=\"nav-item\">
\t\t\t\t\t\t\t<a class=\"nav-link\">
...
\t\t\t\t\t\t\t\t10.00 - 18.00 </a></li></ul></nav><ul class=\"desktop user-menu\"><li class=\"nav-item\">
\t\t\t\t\t\t<a class=\"nav-link\" href=\"/login\" data-toggle=\"modal\" data-target=\"#login-dialog\">
\t\t\t\t\t\t\t<i class=\"fa fa-user\"></i> <span>Вход</span>
\t\t\t\t\t\t</a></li><li class=\"nav-item\">
\t\t\t\t\t\t<a class=\"nav-link\" href=\"/signup\"><span>Регистрация</span></a></li></ul><dialog id=\"login-dialog\" class=\"modal-custom\">
\t\t\t\t\t<button class=\"dialog-close-btn\" data-dismiss=\"modal\" type=\"button\">
\t\t\t\t\t\t<img src=\"/img/cross.svg\" alt=\"\">
\t\t\t\t\t</button><div class=\"dialog-title\">Вход</div><div class=\"dialog-sub-title\">Если у Вас есть зарегистрированный акаунт,<br>
\t\t\t\t\t\tпожалуйста авторизуйтесь</div><form id=\"w0\" action=\"/login\" method=\"post\">
\t\t\t\t\t\t<input type=\"hidden\" name=\"_csrf-frontend\" value=\"05q_4IqQbI-Yklbv-BgthcESQQvEQOdCb8IoSOv2y_2no8-B6P4VwM2gbp6VIR3AkGh5RYlzqXoJ924Mgb_7hw==\"><div class=\"form-group\"><div class=\"form-group field-loginformmodal-email required\">
\t\t\t\t\t\t\t\t<label class=\"required-label\" for=\"loginformmodal-email\">Электронная
\t\t\t\t\t\t\t\t\tпочта или контактный телефон</label>
\t\t\t\t\t\t\t\t<input type=\"text\" id=\"loginformmodal-email\" class=\"form-control\" name=\"LoginFormModal[email]\" aria-required=\"true\"><div class=\"help-block\"></div></div></div><div class=\"form-group\"><div class=\"form-group field-loginformmodal-password required\">
\t\t\t\t\t\t\t\t<label class=\"required-label\" for=\"loginformmodal-password\">Пароль</label>
\t\t\t\t\t\t\t\t<input type=\"password\" id=\"loginformmodal-password\" class=\"form-control\" name=\"LoginFormModal[password]\" aria-required=\"true\"><div class=\"help-block\"></div></div></div><div class=\"form-group\"><div class=\"form-group field-loginformmodal-captcha\"><input type=\"hidden\" id=\"loginformmodal-captcha\" class=\"form-control\" name=\"LoginFormModal[captcha]\" value=\"HFcG9rYxZPZQQ9Q2deXkVPXwA_cBU1SypuMi8pKg4OLhgaKiw-ckooIDpnKDVLM20AMQhFFBwYWVpVZngHXTItBDkqQWxYBjRvEjMjJW1OMz8-Qy0oV0FuQ1hxLl1hd1R8f0hueWArUjpbJioxAQlG\"><div class=\"help-block\"></div></div></div><div class=\"form-group\">
\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-block\">Войти</button></div><div class=\"form-group\">
\t\t\t\t\t\t\t<a class=\"btn btn-default btn-block\" data-dismiss=\"modal\" data-toggle=\"modal\" data-target=\"#password-recovery-dialog\">Забыли
\t\t\t\t\t\t\t\tпароль?</a></div></form></dialog><dialog id=\"password-recovery-dialog\" class=\"modal-custom\">
\t\t\t\t\t<button class=\"dialog-close-btn\" data-dismiss=\"modal\" type=\"button\">
\t\t\t\t\t\t<img src=\"/img/cross.svg\" alt=\"\">
\t\t\t\t\t</button><div class=\"dialog-title\">Восстановление пароля</div><div class=\"dialog-sub-title\">Ссылка на страницу изменения пароля будет
\t\t\t\t\t\tотправлена на адрес Вашей электронной
\t\t\t\t\t\tпочты.</div><form id=\"w1\" class=\"required-asterisk\" action=\"/request-password-reset\" method=\"post\">
\t\t\t\t\t\t<input type=\"hidden\" name=\"_csrf-frontend\" value=\"05q_4IqQbI-Yklbv-BgthcESQQvEQOdCb8IoSOv2y_2no8-B6P4VwM2gbp6VIR3AkGh5RYlzqXoJ924Mgb_7hw==\"><div class=\"form-group\"><div class=\"form-group field-passwordresetrequestform-email required\">
\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"passwordresetrequestform-email\">Электронная почта</label>
\t\t\t\t\t\t\t\t<input type=\"text\" id=\"passwordresetrequestform-email\" class=\"form-control\" name=\"PasswordResetRequestForm[email]\" aria-required=\"true\"><div class=\"help-block\"></div></div></div><div class=\"form-group\">
\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-block\">Отправить</button></div><div class=\"form-group\">
\t\t\t\t\t\t\t<a class=\"btn btn-default btn-block\" data-toggle=\"modal\" data-target=\"#login-dialog\" data-dismiss=\"modal\">Вернуться на форму
\t\t\t\t\t\t\t\tавторизации</a></div></form></dialog></div>
...
\t\t\t\t\t<div class=\"row\">
          ...
          <a class=\"breadcrumb-item\" href=\"/\">Главная</a><span class=\"breadcrumb-item active\" aria-current=\"page\">Видеодомофоны</span></div>
...
";
    ...
    {
        return array (  522 => 733,  390 => 603,  382 => 602,  370 => 601,  169 => 402,  160 => 53,  151 => 51,  146 => 50,  135 => 48,  131 => 47,  128 => 46,  119 => 44,  114 => 43,  101 => 41,  97 => 40,  69 => 14,  63 => 12,  60 => 11,  54 => 9,  52 => 8,  48 => 7,  44 => 6,  37 => 1,);
    }
