...
class __TwigTemplate_30bf78300ccac676ddbc2e6d65d3e48ecf0c5cd40c27c9159390d04312bedbfd extends Template
{
    private $source;
    private $macros = [];
...
<ul class=\"category-menu-nav\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            // line 643
            echo twig_get_attribute($this->env, $this->source, $context["category"], "class", [], "any", false, false, false, 643);
            echo "\" href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 643);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 643);
            echo "</a>
                ";
            // line 644
            if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 644)) {
                // line 645
                echo "                    <div class=\"category-popup-sub-menu category-popup-sub-menu_main\">
                        <div class=\"category-popup-sub-menu__inner\">
                            <div class=\"category-popup-sub-menu__item\">
                                ";
                // line 648
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 648));
                foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                    // line 649
                    echo "                                    <div class=\"category-popup-sub-menu__link-wrapper\">
                                        <a class=\"subcategory-link ";
                    // line 650
                    echo twig_get_attribute($this->env, $this->source, $context["child"], "class", [], "any", false, false, false, 650);
                    echo "\" href=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["child"], "href", [], "any", false, false, false, 650);
                    echo "\">";
                    echo twig_get_attribute($this->env, $this->source, $context["child"], "name", [], "any", false, false, false, 650);
                    echo "</a>
                                    </div>
                                ";
                }
...
";
    ...
    {
        return array (  735 => 660,  727 => 657,  721 => 653,  708 => 650,  705 => 649,  701 => 648,  696 => 645,  694 => 644,  686 => 643,  682 => 641,  678 => 640,  37 => 1,);
    }
