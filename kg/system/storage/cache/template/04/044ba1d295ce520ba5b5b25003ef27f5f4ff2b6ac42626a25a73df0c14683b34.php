...
class __TwigTemplate_fa766272248d93ebdd46b96418342e21d15f46393e8dd4e82ad23a11d82f4898 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 25
        echo "\t\t<link href=\"./catalog/view/theme/kg/assets/resources/style_2.css\" rel=\"stylesheet\">
...
<style>
.swiper-button-next {
    /* Установите желаемые размеры и позицию кнопки */
    width: 40px;
    height: 40px;
    position: absolute;
    top: 50%;
    ...
    z-index: 10; /* Установите z-index, чтобы кнопка была поверх других элементов, если это необходимо */

    /* Стилизуйте кнопку в виде стрелки */
    background-color: #fff; /* Цвет фона */
    border: 1px solid #ccc; /* Обводка */
    border-radius: 50%; /* Скругление углов для создания круглой формы */
    text-align: center;
    cursor: pointer;
}

/* Создайте треугольник для стрелки */
.swiper-button-next::after {
    content: '';
    width: 0;
    height: 0;
    border-top: 8px solid transparent; /* Высота треугольника */
    border-bottom: 8px solid transparent;
    border-left: 12px solid #555; /* Ширина треугольника и его цвет */
    position: absolute;
    top: 50%;
    right: 50%;
    transform: translateY(-50%) translateX(25%); /* Сместите треугольник вправо */
}
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 2688
            echo "\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 2688);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 2688);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 2688);
            echo "\"/>
";
        }
        $_parent = $context['_parent'];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["link"]) {
            // line 2695
            echo "\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["link"], "href", [], "any", false, false, false, 2695);
            echo "\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["link"], "rel", [], "any", false, false, false, 2695);
            echo "\"/>
";
        }
        $_parent = $context['_parent'];
...
\t\t\t<div style=\"max-width: 255px; width: 700px;\" id=\"logo\">
\t\t\t\t<div class=\"img-container\">
\t\t\t\t\t";
        // line 3012
        if (($context["logo"] ?? null)) {
...
";
    ...
    {
        return array (  3369 => 3144,  3290 => 3072,  3283 => 3068,  3232 => 3019,  3224 => 3016,  3221 => 3015,  3209 => 3013,  3207 => 3012,  3125 => 2933,  3088 => 2899,  2913 => 2727,  2904 => 2720,  2896 => 2717,  2893 => 2716,  2881 => 2714,  2879 => 2713,  2864 => 2700,  2855 => 2698,  2851 => 2697,  2840 => 2695,  2836 => 2694,  2833 => 2693,  2824 => 2691,  2820 => 2690,  2807 => 2688,  2803 => 2687,  154 => 40,  145 => 38,  140 => 37,  129 => 35,  125 => 34,  122 => 33,  113 => 31,  108 => 30,  95 => 28,  91 => 27,  87 => 25,  84 => 23,  79 => 19,  75 => 15,  69 => 13,  66 => 12,  60 => 10,  58 => 9,  54 => 8,  50 => 7,  40 => 2,  37 => 1,);
    }
